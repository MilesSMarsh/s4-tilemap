...
function drawTexture(row: number, col: number, ctx: CanvasRenderingContext2D, imageNum: number, width: number, height: number, cellSize: number) {
    const selectableImage = new Image();
    selectableImage.src = imageUrls[imageNum];
